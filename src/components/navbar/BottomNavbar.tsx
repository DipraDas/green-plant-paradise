        ...
        <div className="bg-gray-100">
            <div className="container mx-auto">
                <div className="px-32 py-5 flex justify-center gap-6">
                    ...
                    <div className="w-[2px] h-ful bg-gray-300"></div>
                    <Link to="/category" className="text-xs font-semibold cursor-pointer text-gray-600 tracking-widest">ADD CATEGORY</Link>
                    <div className="w-[2px] h-ful bg-gray-300"></div>
                    <Link to="/product" className="text-xs font-semibold cursor-pointer text-gray-600 tracking-widest">ADD PRODUCT</Link>
                </div>
            </div>
        </div>
    );
